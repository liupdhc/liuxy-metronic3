var ComponentsFormTools = function () {
    ...
    var handleBootstrapMaxlength = function() {
        ...
        $('#maxlength_placement').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true,
            placement: JUI.isRTL() ? 'top-right' : 'top-left'
        });
    }
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            if (input.val() === "") {
                ...
                pop.popover('destroy');
                pop.popover({
                    'placement': (JUI.isRTL() ? 'left' : 'right'),
                    'html': true,
                    'container': 'body',
                ...
                // set last poped popover to be closed on click(see JUI.js => handlePopovers function)
                JUI.setLastPopedPopover(pop);
                pop.popover('show');
