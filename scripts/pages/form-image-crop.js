var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            JUI.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            JUI.updateUniform('#ar_lock,#size_lock,#bg_swap');
    ...
    return {
        ...
        init: function () {
            ...
            JUI.addResizeHandler(handleResponsive);
            handleResponsive();
